...
HRESULT gameOverUI::init()
{
	...
	_timerUI->init(9, 2, CAMERAMANAGER->getCameraCenterX(), CAMERAMANAGER->getCameraBOTTOM() - 100);
	return S_OK;
}
...
void gameOverUI::update()
{
	if (_isGameOver)
	{
		_timerUI->update(CAMERAMANAGER->getCameraCenterX(), CAMERAMANAGER->getCameraBOTTOM() - 100);
