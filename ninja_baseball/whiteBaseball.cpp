...
{
	IMAGEMANAGER->addFrameImage("wBaseball_move", "image/wBaseball_move.bmp", 2880, 600, 8, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_idle", "image/wBaseball_idle.bmp", 1080, 600, 3, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_damaged", "image/wBaseball_damaged.bmp", 1440, 600, 4, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_hang", "image/wBaseball_hang.bmp", 360, 600, 1, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_kick", "image/wBaseball_kick.bmp", 1440, 600, 4, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_land", "image/wBaseball_land.bmp", 1440, 600, 4, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_punch", "image/wBaseball_punch.bmp", 720, 600, 2, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_roll", "image/wBaseball_roll.bmp", 4320, 600, 12, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_spin", "image/wBaseball_spin.bmp", 1440, 600, 4, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("wBaseball_stop", "image/wBaseball_stop.bmp", 1440, 600, 4, 2, true, RGB(255, 0, 255));

	IMAGEMANAGER->addImage("wBaseball_deathL", "image/wBaseball_deathL.bmp", 360, 300, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("wBaseball_deathR", "image/wBaseball_deathR.bmp", 360, 300, true, RGB(255, 0, 255));

}

void whiteBaseball::setShadow()
{
	IMAGEMANAGER->addImage("wBaseball_shadow", "image/wBaseball_shadow.bmp", 215, 50, true, RGB(255, 0, 255));
