...
void card::setImage()
{
	...
	IMAGEMANAGER->addFrameImage("card_death", "image/3_Enemy/card_death.bmp", 2250, 428, 5, 2, true, RGB(255, 0, 255), false);
	IMAGEMANAGER->addFrameImage("card_idle", "image/3_Enemy/card_idle.bmp", 900, 428, 2, 2, true, RGB(255, 0, 255), false);
	IMAGEMANAGER->addFrameImage("card_move", "image/3_Enemy/card_move.bmp", 1800, 428, 4, 2, true, RGB(255, 0, 255), false);
	IMAGEMANAGER->addFrameImage("card_stun", "image/3_Enemy/card_stun.bmp", 1350, 428, 3, 2, true, RGB(255, 0, 255), false);


	/////////////////////////////////////////////////////
	//             카드 쉐도우 프레임
	////////////////////////////////////////////////////
	IMAGEMANAGER->addImage("card_shadow", "image/3_Enemy/card_shadow.bmp", 133, 39, true, RGB(255, 0, 255), false);
}
